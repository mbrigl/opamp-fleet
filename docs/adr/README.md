...
| [0038](0038-an-agent-that-stops-reporting-goes-stale.md) | An Agent that stops reporting goes stale — liveness beside connectedness, never instead of it | 🟡 proposed |
